...
class Parent
{
  public Parent()
  {
    System.out.println("0 Parameter Constructor Inside Parent");
  }
  public Parent(int a, int b)
  {
    System.out.println("Constructor with 2 Integer type Parameters Inside Parent");
     System.out.println(a+b);
  }
  public Parent(float P, float T, float R)
  {
    System.out.println("Constructor with 3 Float type Parameters Inside Parent");
